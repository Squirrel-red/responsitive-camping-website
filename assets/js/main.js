...
const bgHeader =() =>{
    ...
    // When the scroll is higher than 50 viewport height, add the bg-header class to the tag with the header class
...
gsap.from('.home__img-1', 1.2, {opacity: 0, y: 200, delay: 1.1})
